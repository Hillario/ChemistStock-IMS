                ...
                <div class="profile-widget profile-widget-info">
                    <div class="panel-body">
                        ...
                        <div class="col-lg-4 col-sm-4 follow-info">
                            ...
                            $doctorQuery="SELECT * FROM admin WHERE admin_id='".$uid."'";
                            ...
                            ?>
                            <p>Profile details of user with priviledges as an Administrator</p>
                            <p><?php echo $em;?></p>
                            <h6>
                                <span><i class="icon_clock_alt"></i>Last updated at: <?php echo $rs;?></span>
                            </h6>
                        </div>
                    </div>
                </div>
