...
$mydbQuery="select S.Stockid,S.ProductName,S.ExpiryDate,O.DateOut,S.BatchNumber,S.buyingprice,S.sellingprice,S.discount,S.Quantity,S.total,O.OutgoingQuantity,O.CustomerName,O.outgoingtotal FROM stock S,outgoingstock O WHERE S.Stockid=O.Stockid AND S.Storeid='$sid' AND S.ProductName LIKE"."'%".$search."%' ORDER BY O.DateOut DESC";
