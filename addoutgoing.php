                ...
                <div class="panel-body">
                    <form role="form" method="post" action="">
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <input name="outgoingid" type="text" class="form-control" list="outgoingid" value="<?php if (isset($_POST['outgoingid'])) $outgoingid = $_POST['outgoingid'];?>"/>
                                <datalist id="outgoingid">
                                    <?php
                        ...
                        <script>
                            $(document).ready(function () {
                                $('input').keyup(function () {
                                    var quo=$('#oquantity').val();
                                    var sellp=$('#sp').val();

                                    var totals=quo*sellp;
                                    $('#temp').val(totals);
                                })
                            })
                        </script>
                        <div class="form-group">
                            ...
                            <input name="temp" type="text" class="form-control" id="temp">
                        </div>
                        <div class="form-group">
                    ...
                    if (isset($error)) {
                        if (!empty($error)) {
                            ...
                            $ototal;
                            $fsellingprice=$sp-$dis;//find the differenc between the stock value change so said
                            ...
                            if($sdiff<=$minquan){
                                ...
                                //insert query here
                                $insertQuery = "INSERT INTO `stockmanagement`.`outgoingstock` (`Outgoingid`, `DateOut`,`OutgoingQuantity`,`outgoingtotal`,`Stockid`,`Userid`) VALUES (NULL,CURRENT_TIMESTAMP(), '" . $oquantity . "','" . $ototal . "','" . $id . "','" . $uid . "');";
